...
def anime_movies(request):
    render_ = 'anime_movies.html'
    redirect_ = '/anime-movies'
    ...
    context = {
        # basic info
        'title': 'Flagy | افلام الانمي',
        'description': '[Flagy مشاهدة وتحميل جميع افلام مترجة بجودة عالية ]',
        'css': ['home.css'],
        'js': ['anime_movies/main.js'],
        ...
        # other
        'animes': Animes_animetitans.objects.filter(~Q(Type='أنمي')).order_by('title')
    }
