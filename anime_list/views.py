...
def anime_list(request):
    render_ = 'anime_list.html'
    redirect_ = '/anime-list'
    ...
    context = {
        # basic info
        'title': 'Flagy | قائمة الانمي',
        'description': 'Flagy مشاهدة وتحميل جميع الانميات مترجة بجودة عالية ',
        'css': ['home.css'],
        'js': ['anime_list/main.js'],
        ...
        # other
        'animes': Animes_animetitans.objects.all().order_by('title')
    }
