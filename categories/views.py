...
def categories(request, slug):
    ...
    this_category = Categories_animetitans.objects.get(slug=slug)
    context = {
        # basic info
        'title': f'Flagy {this_category}',
        'description': f'Flagy جميع انميات {this_category} مع ',
        'css': ['home.css'],
        'js': [],
        ...
        # other
        'animes': Animes_animetitans.objects.all(),
        'cat_by': Categories_animetitans.objects.get(slug=slug),
